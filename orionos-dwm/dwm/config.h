...
/**
 * orionos DWM (Dynamic Window Manager) configuration
 * custom DWM for orionos
 *
...
static const char *orionosmenu[]	= { "dmenu_run", "-b","-p", "orionos", "-fn", "drift:pixelsize=12", "-lh", "22","-nf", "#D0D3D1", "-nb", "#000000", "-sf", "#000000", "-sb", "#D0D3D1", NULL };
...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask,     XK_d,	    spawn,              {.v = orionosmenu } },
